...
ft_201412view.ValidateRequired = true;
<?php } else { ?>
ft_201412view.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_201412view.Lists["x_t_lab_db_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_COL_2","x_COL_3","x_COL_4","x_id"],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_lab_db"};
...
<?php if (!isset($t_201412_view->Pager)) $t_201412_view->Pager = new cPrevNextPager($t_201412_view->StartRec, $t_201412_view->DisplayRecs, $t_201412_view->TotalRecs) ?>
...
<?php if ($t_201412->COL_2->Visible) { // COL 2 ?>
	<tr id="r_COL_2">
		<td><span id="elh_t_201412_COL_2"><?php echo $t_201412->COL_2->FldCaption() ?></span></td>
...
<?php if ($t_201412->COL_4->Visible) { // COL 4 ?>
	<tr id="r_COL_4">
		<td><span id="elh_t_201412_COL_4"><?php echo $t_201412->COL_4->FldCaption() ?></span></td>
...
<?php if ($t_201412->COL_5->Visible) { // COL 5 ?>
	<tr id="r_COL_5">
		<td><span id="elh_t_201412_COL_5"><?php echo $t_201412->COL_5->FldCaption() ?></span></td>
...
<?php if ($t_201412->COL_6->Visible) { // COL 6 ?>
	<tr id="r_COL_6">
		<td><span id="elh_t_201412_COL_6"><?php echo $t_201412->COL_6->FldCaption() ?></span></td>
...
<?php if ($t_201412->t_lab_db_id->Visible) { // t_lab_db_id ?>
	<tr id="r_t_lab_db_id">
		<td><span id="elh_t_201412_t_lab_db_id"><?php echo $t_201412->t_lab_db_id->FldCaption() ?></span></td>
