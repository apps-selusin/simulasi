...
$t_201412_view = NULL; // Initialize page object first

class ct_201412_view extends ct_201412 {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t_201412list.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t_201412list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t_201412_view)) $t_201412_view = new ct_201412_view();

// Page init
$t_201412_view->Page_Init();

// Page main
$t_201412_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_201412_view->Page_Render();
?>
...
var CurrentForm = ft_201412view = new ew_Form("ft_201412view", "view");

// Form_CustomValidate event
ft_201412view.Form_CustomValidate = 
...
ft_201412view.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($t_201412->Export == "") { ?>
<div class="ewToolbar">
<?php $t_201412_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_201412_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $t_201412_view->ShowPageHeader(); ?>
<?php
$t_201412_view->ShowMessage();
?>
<?php if (!$t_201412_view->IsModal) { ?>
<?php if ($t_201412->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_201412_view->Pager)) $t_201412_view->Pager = new cPrevNextPager($t_201412_view->StartRec, $t_201412_view->DisplayRecs, $t_201412_view->TotalRecs, $t_201412_view->AutoHidePager) ?>
<?php if ($t_201412_view->Pager->RecordCount > 0 && $t_201412_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_201412_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_201412_view->PageUrl() ?>start=<?php echo $t_201412_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_201412_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_201412_view->PageUrl() ?>start=<?php echo $t_201412_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_201412_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_201412_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_201412_view->PageUrl() ?>start=<?php echo $t_201412_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_201412_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_201412_view->PageUrl() ?>start=<?php echo $t_201412_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_201412_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft_201412view" id="ft_201412view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_201412_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_201412_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t_201412">
<input type="hidden" name="modal" value="<?php echo intval($t_201412_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($t_201412->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_t_201412_id"><?php echo $t_201412->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $t_201412->id->CellAttributes() ?>>
<span id="el_t_201412_id">
<span<?php echo $t_201412->id->ViewAttributes() ?>>
<?php echo $t_201412->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_201412->COL_1->Visible) { // COL 1 ?>
	<tr id="r_COL_1">
		<td class="col-sm-2"><span id="elh_t_201412_COL_1"><?php echo $t_201412->COL_1->FldCaption() ?></span></td>
...
<?php echo $t_201412->COL_1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_201412->COL_2->Visible) { // COL 2 ?>
	<tr id="r_COL_2">
		<td class="col-sm-2"><span id="elh_t_201412_COL_2"><?php echo $t_201412->COL_2->FldCaption() ?></span></td>
...
<?php echo $t_201412->COL_2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_201412->COL_3->Visible) { // COL 3 ?>
	<tr id="r_COL_3">
		<td class="col-sm-2"><span id="elh_t_201412_COL_3"><?php echo $t_201412->COL_3->FldCaption() ?></span></td>
...
<?php echo $t_201412->COL_3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_201412->COL_4->Visible) { // COL 4 ?>
	<tr id="r_COL_4">
		<td class="col-sm-2"><span id="elh_t_201412_COL_4"><?php echo $t_201412->COL_4->FldCaption() ?></span></td>
...
<?php echo $t_201412->COL_4->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_201412->COL_5->Visible) { // COL 5 ?>
	<tr id="r_COL_5">
		<td class="col-sm-2"><span id="elh_t_201412_COL_5"><?php echo $t_201412->COL_5->FldCaption() ?></span></td>
...
<?php echo $t_201412->COL_5->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_201412->COL_6->Visible) { // COL 6 ?>
	<tr id="r_COL_6">
		<td class="col-sm-2"><span id="elh_t_201412_COL_6"><?php echo $t_201412->COL_6->FldCaption() ?></span></td>
...
<?php echo $t_201412->COL_6->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_201412->COL_7->Visible) { // COL 7 ?>
	<tr id="r_COL_7">
		<td class="col-sm-2"><span id="elh_t_201412_COL_7"><?php echo $t_201412->COL_7->FldCaption() ?></span></td>
...
<?php echo $t_201412->COL_7->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_201412->COL_8->Visible) { // COL 8 ?>
	<tr id="r_COL_8">
		<td class="col-sm-2"><span id="elh_t_201412_COL_8"><?php echo $t_201412->COL_8->FldCaption() ?></span></td>
...
<?php echo $t_201412->COL_8->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_201412->t_lab_db_id->Visible) { // t_lab_db_id ?>
	<tr id="r_t_lab_db_id">
		<td class="col-sm-2"><span id="elh_t_201412_t_lab_db_id"><?php echo $t_201412->t_lab_db_id->FldCaption() ?></span></td>
...
<?php echo $t_201412->t_lab_db_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
