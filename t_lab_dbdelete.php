...
ft_lab_dbdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($t_lab_db->id->Visible) { // id ?>
		<th class="<?php echo $t_lab_db->id->HeaderCellClass() ?>"><span id="elh_t_lab_db_id" class="t_lab_db_id"><?php echo $t_lab_db->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_lab_db->COL_1->Visible) { // COL 1 ?>
		<th class="<?php echo $t_lab_db->COL_1->HeaderCellClass() ?>"><span id="elh_t_lab_db_COL_1" class="t_lab_db_COL_1"><?php echo $t_lab_db->COL_1->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_lab_db->COL_2->Visible) { // COL 2 ?>
		<th class="<?php echo $t_lab_db->COL_2->HeaderCellClass() ?>"><span id="elh_t_lab_db_COL_2" class="t_lab_db_COL_2"><?php echo $t_lab_db->COL_2->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_lab_db->COL_3->Visible) { // COL 3 ?>
		<th class="<?php echo $t_lab_db->COL_3->HeaderCellClass() ?>"><span id="elh_t_lab_db_COL_3" class="t_lab_db_COL_3"><?php echo $t_lab_db->COL_3->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_lab_db->COL_4->Visible) { // COL 4 ?>
		<th class="<?php echo $t_lab_db->COL_4->HeaderCellClass() ?>"><span id="elh_t_lab_db_COL_4" class="t_lab_db_COL_4"><?php echo $t_lab_db->COL_4->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
