...
class ct_201412_add extends ct_201412 {
	...
	function LoadDefaultValues() {
		...
		$this->COL_1->CurrentValue = NULL;
		$this->COL_1->OldValue = $this->COL_1->CurrentValue;
		...
		$this->COL_7->CurrentValue = NULL;
		$this->COL_7->OldValue = $this->COL_7->CurrentValue;
		$this->COL_8->CurrentValue = NULL;
		$this->COL_8->OldValue = $this->COL_8->CurrentValue;
	...
	function NewRow() {
		...
		$row['COL 1'] = $this->COL_1->CurrentValue;
		$row['COL 2'] = $this->COL_2->CurrentValue;
		$row['COL 3'] = $this->COL_3->CurrentValue;
		$row['COL 4'] = $this->COL_4->CurrentValue;
		$row['COL 5'] = $this->COL_5->CurrentValue;
		$row['COL 6'] = $this->COL_6->CurrentValue;
		$row['COL 7'] = $this->COL_7->CurrentValue;
		$row['COL 8'] = $this->COL_8->CurrentValue;
		$row['t_lab_db_id'] = $this->t_lab_db_id->CurrentValue;
		return $row;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// COL 1
		$this->COL_1->SetDbValueDef($rsnew, $this->COL_1->CurrentValue, NULL, FALSE);
		...
		// COL 7
		$this->COL_7->SetDbValueDef($rsnew, $this->COL_7->CurrentValue, NULL, FALSE);

		// COL 8
		$this->COL_8->SetDbValueDef($rsnew, $this->COL_8->CurrentValue, NULL, FALSE);
...
ft_201412add.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($t_201412_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($t_201412->COL_1->Visible) { // COL 1 ?>
	<div id="r_COL_1" class="form-group">
		<label id="elh_t_201412_COL_1" for="x_COL_1" class="<?php echo $t_201412_add->LeftColumnClass ?>"><?php echo $t_201412->COL_1->FldCaption() ?></label>
		<div class="<?php echo $t_201412_add->RightColumnClass ?>"><div<?php echo $t_201412->COL_1->CellAttributes() ?>>
...
<?php if ($t_201412->COL_2->Visible) { // COL 2 ?>
	<div id="r_COL_2" class="form-group">
		<label id="elh_t_201412_COL_2" for="x_COL_2" class="<?php echo $t_201412_add->LeftColumnClass ?>"><?php echo $t_201412->COL_2->FldCaption() ?></label>
		<div class="<?php echo $t_201412_add->RightColumnClass ?>"><div<?php echo $t_201412->COL_2->CellAttributes() ?>>
...
<?php if ($t_201412->COL_3->Visible) { // COL 3 ?>
	<div id="r_COL_3" class="form-group">
		<label id="elh_t_201412_COL_3" for="x_COL_3" class="<?php echo $t_201412_add->LeftColumnClass ?>"><?php echo $t_201412->COL_3->FldCaption() ?></label>
		<div class="<?php echo $t_201412_add->RightColumnClass ?>"><div<?php echo $t_201412->COL_3->CellAttributes() ?>>
...
<?php if ($t_201412->COL_4->Visible) { // COL 4 ?>
	<div id="r_COL_4" class="form-group">
		<label id="elh_t_201412_COL_4" for="x_COL_4" class="<?php echo $t_201412_add->LeftColumnClass ?>"><?php echo $t_201412->COL_4->FldCaption() ?></label>
		<div class="<?php echo $t_201412_add->RightColumnClass ?>"><div<?php echo $t_201412->COL_4->CellAttributes() ?>>
...
<?php if ($t_201412->COL_5->Visible) { // COL 5 ?>
	<div id="r_COL_5" class="form-group">
		<label id="elh_t_201412_COL_5" for="x_COL_5" class="<?php echo $t_201412_add->LeftColumnClass ?>"><?php echo $t_201412->COL_5->FldCaption() ?></label>
		<div class="<?php echo $t_201412_add->RightColumnClass ?>"><div<?php echo $t_201412->COL_5->CellAttributes() ?>>
...
<?php if ($t_201412->COL_6->Visible) { // COL 6 ?>
	<div id="r_COL_6" class="form-group">
		<label id="elh_t_201412_COL_6" for="x_COL_6" class="<?php echo $t_201412_add->LeftColumnClass ?>"><?php echo $t_201412->COL_6->FldCaption() ?></label>
		<div class="<?php echo $t_201412_add->RightColumnClass ?>"><div<?php echo $t_201412->COL_6->CellAttributes() ?>>
...
<?php if ($t_201412->COL_7->Visible) { // COL 7 ?>
	<div id="r_COL_7" class="form-group">
		<label id="elh_t_201412_COL_7" for="x_COL_7" class="<?php echo $t_201412_add->LeftColumnClass ?>"><?php echo $t_201412->COL_7->FldCaption() ?></label>
		<div class="<?php echo $t_201412_add->RightColumnClass ?>"><div<?php echo $t_201412->COL_7->CellAttributes() ?>>
...
<?php if ($t_201412->COL_8->Visible) { // COL 8 ?>
	<div id="r_COL_8" class="form-group">
		<label id="elh_t_201412_COL_8" for="x_COL_8" class="<?php echo $t_201412_add->LeftColumnClass ?>"><?php echo $t_201412->COL_8->FldCaption() ?></label>
		<div class="<?php echo $t_201412_add->RightColumnClass ?>"><div<?php echo $t_201412->COL_8->CellAttributes() ?>>
...
<?php if ($t_201412->t_lab_db_id->Visible) { // t_lab_db_id ?>
	<div id="r_t_lab_db_id" class="form-group">
		<label id="elh_t_201412_t_lab_db_id" for="x_t_lab_db_id" class="<?php echo $t_201412_add->LeftColumnClass ?>"><?php echo $t_201412->t_lab_db_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t_201412_add->RightColumnClass ?>"><div<?php echo $t_201412->t_lab_db_id->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $t_201412_add->OffsetColumnClass ?>"><!-- buttons offset -->
