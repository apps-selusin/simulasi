...
ft_201412delete.ValidateRequired = true;
<?php } else { ?>
ft_201412delete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_201412delete.Lists["x_t_lab_db_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_COL_2","x_COL_3","x_COL_4","x_id"],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_lab_db"};
...
<?php if ($t_201412->COL_2->Visible) { // COL 2 ?>
		<th><span id="elh_t_201412_COL_2" class="t_201412_COL_2"><?php echo $t_201412->COL_2->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_201412->COL_4->Visible) { // COL 4 ?>
		<th><span id="elh_t_201412_COL_4" class="t_201412_COL_4"><?php echo $t_201412->COL_4->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_201412->COL_5->Visible) { // COL 5 ?>
		<th><span id="elh_t_201412_COL_5" class="t_201412_COL_5"><?php echo $t_201412->COL_5->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_201412->COL_6->Visible) { // COL 6 ?>
		<th><span id="elh_t_201412_COL_6" class="t_201412_COL_6"><?php echo $t_201412->COL_6->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_201412->t_lab_db_id->Visible) { // t_lab_db_id ?>
		<th><span id="elh_t_201412_t_lab_db_id" class="t_201412_t_lab_db_id"><?php echo $t_201412->t_lab_db_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
