...
$t_lab_db_add = NULL; // Initialize page object first

class ct_lab_db_add extends ct_lab_db {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("t_lab_dblist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_lab_dbview.php")
...
// Create page object
if (!isset($t_lab_db_add)) $t_lab_db_add = new ct_lab_db_add();

// Page init
$t_lab_db_add->Page_Init();

// Page main
$t_lab_db_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_lab_db_add->Page_Render();
?>
...
var CurrentForm = ft_lab_dbadd = new ew_Form("ft_lab_dbadd", "add");

// Validate form
ft_lab_dbadd.Validate = function() {
...
ft_lab_dbadd.Form_CustomValidate = 
...
ft_lab_dbadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $t_lab_db_add->ShowPageHeader(); ?>
<?php
$t_lab_db_add->ShowMessage();
?>
<form name="ft_lab_dbadd" id="ft_lab_dbadd" class="<?php echo $t_lab_db_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_lab_db_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_lab_db_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t_lab_db">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($t_lab_db_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($t_lab_db->COL_1->Visible) { // COL 1 ?>
	<div id="r_COL_1" class="form-group">
		<label id="elh_t_lab_db_COL_1" for="x_COL_1" class="<?php echo $t_lab_db_add->LeftColumnClass ?>"><?php echo $t_lab_db->COL_1->FldCaption() ?></label>
		<div class="<?php echo $t_lab_db_add->RightColumnClass ?>"><div<?php echo $t_lab_db->COL_1->CellAttributes() ?>>
...
<?php if ($t_lab_db->COL_2->Visible) { // COL 2 ?>
	<div id="r_COL_2" class="form-group">
		<label id="elh_t_lab_db_COL_2" for="x_COL_2" class="<?php echo $t_lab_db_add->LeftColumnClass ?>"><?php echo $t_lab_db->COL_2->FldCaption() ?></label>
		<div class="<?php echo $t_lab_db_add->RightColumnClass ?>"><div<?php echo $t_lab_db->COL_2->CellAttributes() ?>>
...
<?php if ($t_lab_db->COL_3->Visible) { // COL 3 ?>
	<div id="r_COL_3" class="form-group">
		<label id="elh_t_lab_db_COL_3" for="x_COL_3" class="<?php echo $t_lab_db_add->LeftColumnClass ?>"><?php echo $t_lab_db->COL_3->FldCaption() ?></label>
		<div class="<?php echo $t_lab_db_add->RightColumnClass ?>"><div<?php echo $t_lab_db->COL_3->CellAttributes() ?>>
...
<?php if ($t_lab_db->COL_4->Visible) { // COL 4 ?>
	<div id="r_COL_4" class="form-group">
		<label id="elh_t_lab_db_COL_4" for="x_COL_4" class="<?php echo $t_lab_db_add->LeftColumnClass ?>"><?php echo $t_lab_db->COL_4->FldCaption() ?></label>
		<div class="<?php echo $t_lab_db_add->RightColumnClass ?>"><div<?php echo $t_lab_db->COL_4->CellAttributes() ?>>
...
<?php if (!$t_lab_db_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $t_lab_db_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_lab_db_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
