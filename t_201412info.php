...
class ct_201412 extends cTable {
	...
	function __construct() {
		...
		$this->COL_1->Sortable = TRUE; // Allow sort
		...
		$this->COL_2->Sortable = TRUE; // Allow sort
		...
		$this->COL_3->Sortable = TRUE; // Allow sort
		...
		$this->COL_4->Sortable = TRUE; // Allow sort
		...
		$this->COL_5->Sortable = TRUE; // Allow sort
		...
		$this->COL_6->Sortable = TRUE; // Allow sort
		...
		$this->COL_7->Sortable = TRUE; // Allow sort
		...
		$this->COL_8->Sortable = TRUE; // Allow sort
		$this->COL_8->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['COL 8'] = &$this->COL_8;

		// t_lab_db_id
		$this->t_lab_db_id = new cField('t_201412', 't_201412', 'x_t_lab_db_id', 't_lab_db_id', '`t_lab_db_id`', '`t_lab_db_id`', 3, -1, FALSE, '`t_lab_db_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->t_lab_db_id->Sortable = TRUE; // Allow sort
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "t_201412edit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "t_201412add.php")
	...
	function RenderEditRow() {
		...
		$this->t_lab_db_id->EditValue = $this->t_lab_db_id->CurrentValue;
